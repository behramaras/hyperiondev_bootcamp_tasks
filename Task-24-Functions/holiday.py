...
while True:
    ...
    output = input("To calculate the cost of holiday press '1' or 'q' to quit: ")

    if output == "1":
        
        num_nights = int(input("\nEnter the number of nights will be staying at a hotel: "))
        city = input("\nEnter a city name: ")
        num_days = int(input("\nEnter the number of days the car will be hired : "))

        holiday_cost(num_nights, city, num_days)
